...
export default function InfoCardDescription() {
  const sharedStyles = "font-default block py-2 text-base";
  ...
  return (
    <>
      ...
      <span className={cn(sharedStyles)}>
        I&apos;m experienced in translating complex business requirements into technical solutions, creating enterprise
        web apps that automate/simplify/quantify workflows
      </span>
      <span className={cn(sharedStyles)}>
        {" "}
        As someone who enjoys building long-term solutions and sharing knowledge, I believe I can bring great{" "}
        <strong>value</strong> to your team
      </span>
    </>
  );
}
